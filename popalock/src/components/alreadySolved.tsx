  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="absolute flex flex-col justify-center bg-gradient-to-br from-sky-800 from-0% via-cyan-800 to-cyan-800 rounded-2xl shadow-2xl max-w-lg w-full p-8 overflow-y-scroll h-content">
            <h1 className="text-2xl font-extrabold text-center text-amber-400">You already played todays lock!</h1>
            <p className="text-gray-200 text-center mt-4">Return tomorrow to attempt popping another daily lock! or play infinite mode.</p>
            <button
